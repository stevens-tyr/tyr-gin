...
func TestAboutResponse(t *testing.T) {
	...
	aboutResponseString := About(testStatusEndpoints, AboutProtocolHTTP, "test/about.json", "test/version.txt", emptyCustomData)
...
func TestAboutEmptyAboutData(t *testing.T) {
	...
	aboutResponseString := About(testStatusEndpoints, AboutProtocolHTTP, "", "", emptyCustomData)
...
func TestAboutFieldMissingAboutData(t *testing.T) {
	aboutResponseString := About(testStatusEndpoints, AboutProtocolHTTP, "test/service-id-field-missing.json", "test/version.txt", emptyCustomData)
...
func TestAboutCustomData(t *testing.T) {
	...
	aboutResponseString := About(testStatusEndpoints, AboutProtocolHTTP, "test/about-custom.json", "test/version.txt", serviceCustomData)
...
func TestAboutServiceCustomData(t *testing.T) {
	...
	aboutResponseString := About(testStatusEndpoints, AboutProtocolHTTP, "test/about.json", "test/version.txt", serviceCustomData)
